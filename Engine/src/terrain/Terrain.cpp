...
namespace engine {
	...
	void Terrain::Draw(Shader* shader, RenderPassType pass) const {
		...
		if (pass != RenderPassType::ShadowmapPassType) {
			m_Textures[0]->bind(1);
			shader->setUniform("material.texture_diffuse1", 1);
			m_Textures[1]->bind(2);
			shader->setUniform("material.texture_diffuse2", 2);
			m_Textures[2]->bind(3);
			shader->setUniform("material.texture_diffuse3", 3);
			m_Textures[3]->bind(4);
			shader->setUniform("material.texture_diffuse4", 4);
			m_Textures[4]->bind(5);
			shader->setUniform("material.blendmap", 5);
			m_Textures[5]->bind(6);
			shader->setUniform("material.texture_normal1", 6);
			m_Textures[6]->bind(7);
			shader->setUniform("material.texture_normal2", 7);
			m_Textures[7]->bind(8);
			shader->setUniform("material.texture_normal3", 8);
			m_Textures[8]->bind(9);
			shader->setUniform("material.texture_normal4", 9);
		}
